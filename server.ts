...
async function startServer() {
  ...
  app.post('/api/v1/auth/register', authLimiter, async (req, res) => {
    try {
      ...
      // Sentinel: Validate inputs are strings to prevent Prisma object injection
      if (typeof email !== 'string' || typeof username !== 'string' || typeof password !== 'string' || (name !== undefined && typeof name !== 'string')) {
