      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mt-8 pt-8 border-t border-slate-200 dark:border-slate-700">
          <div className="flex items-center gap-4">
            <button aria-label={`${likes} Likes`} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 focus-visible:ring-2 focus-visible:outline-none transition-colors">
              <Heart className="w-5 h-5" /> <span>{likes}</span>
            </button>
            <button aria-label="12 Comments" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 focus-visible:ring-2 focus-visible:outline-none transition-colors">
              <MessageSquare className="w-5 h-5" /> <span>12</span>
            </button>
          </div>
          <div className="flex items-center gap-2">
            <button aria-label="Bookmark" className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 focus-visible:ring-2 focus-visible:outline-none transition-colors">
              <Bookmark className="w-5 h-5" />
            </button>
            <button aria-label="Share" className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 focus-visible:ring-2 focus-visible:outline-none transition-colors">
