        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-center gap-2 mt-12">
            <button
              ...
              className="p-2 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 disabled:opacity-50 focus-visible:ring-2 focus-visible:outline-none"
            >
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
              <button
                ...
                className={`w-10 h-10 rounded-lg text-sm font-medium focus-visible:ring-2 focus-visible:outline-none ${
                  currentPage === page
                    ? 'bg-slate-900 dark:bg-white text-white dark:text-slate-900'
