    ...
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 xl:pl-24 py-8">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-slate-700 dark:text-slate-300">
          ...
          <h2>5. Contact Us</h2>
          <p>If you have any questions about this privacy policy or our privacy practices, please contact us at privacy@thedailypulse.com or 123 Media Ave, Suite 400, New York, NY 10001.</p>
        </div>
      </div>
    </div>
  );
