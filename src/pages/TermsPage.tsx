...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
      <Helmet>
        <title>Terms of Service | The Daily Pulse</title>
        <meta name="description" content="Read the Terms of Service for The Daily Pulse. By using our website, you agree to these terms and conditions." />
        <link rel="canonical" href="https://articleblogwebsite.web.app/terms" />
      </Helmet>
